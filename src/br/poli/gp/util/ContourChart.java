...
public class ContourChart implements DemoModule
{
    ...
    public ContourChart(double[] x, double[] y, double[] z, String textX_, String textY_) {
    ...
    public void createChart(ChartViewer viewer, int chartIndex)
    {
        ...
        c.addTitle("BestFitness", "Arial Bold Italic", 15);
        ...
        c.xAxis().setTitle(textX, "Arial Bold Italic", 12);
        c.yAxis().setTitle(textY, "Arial Bold Italic", 12);
        ...
        //essa linha é importante para melhorar a interpolação
    ...
    public static void main(String[] args)
    {
        ...
        double[] dataX = {-10, -9.5, -9, -8.5, -8, -7.5, -7, -6.5, -6, -5.5, -5, -4.5, -4, -3.5, -3,
                -2.5, -2, -1.5, -1, -0.5, 0, 0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7,
                7.5, 8, 8.5, 9, 9.5, 10};

        double[] dataY = {-10, -9.5, -9, -8.5, -8, -7.5, -7, -6.5, -6, -5.5, -5, -4.5, -4, -3.5, -3,
                -2.5, -2, -1.5, -1, -0.5, 0, 0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7,
                7.5, 8, 8.5, 9, 9.5, 10};
        ...
        DemoModule demo = new ContourChart(dataX, dataY, dataZ, "", "");
