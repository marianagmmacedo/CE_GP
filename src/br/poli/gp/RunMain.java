...
public class RunMain {
	...
	static void mainCarlos() throws Exception{
		...
		*/
		...
		//Esse m�todo j� puxa todas as bases do array bases[] e transforma em thread
		ThreadMain.startStack();
		//Esse m�todo escolhe qnts threads v�o rodar de forma uniforme nesse caso eu mandei rodar 13 de uma vez,
		//se n houver 13 bases ele s� termina sem duplicidade :D
