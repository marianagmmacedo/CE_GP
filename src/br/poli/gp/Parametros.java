...
public class Parametros {
	...
	public static final double CHANCE_CRIACAO_VARIAVEL = 0.0d; 
	public static final double TAXA_CRUZAMENTO_MUTACAO = 0.2;
	public static final int TAMANHO_MAXIMO_MUTACAO_PROFUNDIDADE = 3;
	public static final String NOME_CAMINHO_SALVAR_FITNESS = "/Users/mgmmacedo/Documents/CE_GP/resultados";
